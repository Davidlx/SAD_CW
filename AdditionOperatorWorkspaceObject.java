...
class AdditionOperatorWorkspaceObject extends WorkspaceObject
{
   AdditionOperator op;
   PartSink leftSink, rightSink;

   public AdditionOperatorWorkspaceObject(Workspace w)
   {
      super(w);
   }
   ...
   static AdditionOperatorWorkspaceObject load(Node node) throws ProgramLoadingException
   {
      if(!node.getNodeName().equals("addition"))
	 throw new ProgramLoadingException();

      AdditionOperatorWorkspaceObject obj = new AdditionOperatorWorkspaceObject(Workspace.getWorkspace());
