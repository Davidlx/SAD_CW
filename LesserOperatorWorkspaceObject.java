...
class LesserOperatorWorkspaceObject extends WorkspaceObject
{
   LesserOperator op;
   PartSink leftSink, rightSink;

   public LesserOperatorWorkspaceObject(Workspace w)
   {
      super(w);
   }
   ...
   static LesserOperatorWorkspaceObject load(Node node) throws ProgramLoadingException
   {
      if(!node.getNodeName().equals("lesser"))
	 throw new ProgramLoadingException();

      LesserOperatorWorkspaceObject obj = new LesserOperatorWorkspaceObject(Workspace.getWorkspace());
