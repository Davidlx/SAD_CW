...
class DivisionOperatorWorkspaceObject extends WorkspaceObject
{
   DivisionOperator op;
   PartSink leftSink, rightSink;

   public DivisionOperatorWorkspaceObject(Workspace w)
   {
      super(w);
   }
   ...
   static DivisionOperatorWorkspaceObject load(Node node) throws ProgramLoadingException
   {
	 ...
	 throw new ProgramLoadingException();
      ...
      DivisionOperatorWorkspaceObject obj = new DivisionOperatorWorkspaceObject(Workspace.getWorkspace());
